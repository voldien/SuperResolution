...
class SuperResolutionModelCNN(ModelBase):
	...
	def create_model(self, input_shape, output_shape, **kwargs) -> keras.Model:
		...
		return create_cnn_model(input_shape=input_shape,
								   output_shape=output_shape,input_filter_size=64, regularization=regularization, upscale_mode=upscale_mode,
...
def create_cnn_model(input_shape: tuple, output_shape: tuple, input_filter_size : int, regularization: float, upscale_mode: int,
